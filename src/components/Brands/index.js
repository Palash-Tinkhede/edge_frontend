...
const SingleBrand = ({ brand }) => {
    ...
    return (
        <div className="flex w-1/2 items-center justify-center px-3 py-[15px] sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/6">
            ...
            >
                <img src={imageLight} alt={name} className="hidden h-full w-full object-contain dark:block" />
                <img src={image} alt={name} className="block h-full w-full object-contain dark:hidden" />
            </a>
        </div>
    );
};
