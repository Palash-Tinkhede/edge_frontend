...
const SingleTestimonial = ({ testimonial }) => {
    ...
    return (
        <div className="w-full">
            <div className="shadow-two hover:shadow-one dark:bg-dark dark:shadow-three dark:hover:shadow-gray-dark rounded-sm bg-white p-8 duration-300 lg:px-5 xl:px-8">
